    ...
    @section('header')
        <div class="container-menu-desktop">
            ...
            <div class="wrap-menu-desktop">
                <nav class="limiter-menu-desktop container">
                    ...
                    <!-- Logo desktop -->
                    <a href="#" class="logo">
                        <img src="{{ asset('assets/images/client/icons/logo-01.png') }}" alt="IMG-LOGO">
                    </a>
                    ...
                    <div class="menu-desktop">
                        <ul class="main-menu">
                            ...
                            <li>
                                <a href="{{ Route('client-product-list') }}">Shop</a>
                            </li>
        ...
        <div class="wrap-header-mobile">
            ...
            <div class="logo-mobile">
                <a href="index.html"><img src="{{ asset('assets/images/client/icons/logo-01.png') }}" alt="IMG-LOGO"></a>
            </div>
